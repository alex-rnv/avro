...
[![Go Report Card](https://goreportcard.com/badge/github.com/alex-rnv/avro/v2)](https://goreportcard.com/report/github.com/alex-rnv/avro/v2)
...
[![Go Reference](https://pkg.go.dev/badge/github.com/alex-rnv/avro/v2.svg)](https://pkg.go.dev/github.com/alex-rnv/avro/v2)
...
```shell
go get github.com/alex-rnv/avro/v2
```
...
More examples in the [godoc](https://godoc.org/github.com/alex-rnv/avro/v2).
...
```shell
go install github.com/alex-rnv/avro/v2/cmd/avrogen@<version>
```
...
```shell
go install github.com/alex-rnv/avro/v2/cmd/avrosv@<version>
```
